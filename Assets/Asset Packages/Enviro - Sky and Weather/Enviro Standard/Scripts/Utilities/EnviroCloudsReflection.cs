...
public class EnviroCloudsReflection : MonoBehaviour {
    ...
    private void SetCloudProperties()
    {
        ...
        mat.SetFloat("_AmbientSkyColorIntensity", 1 - EnviroSky.instance.cloudsConfig.ambientSkyColorIntensity);
        ...
        mat.SetVector("_CloudsLightingExtended", new Vector4(EnviroSky.instance.cloudsSettings.directionalDarkening.Evaluate(EnviroSky.instance.GameTime.solarTime), 1 - EnviroSky.instance.cloudsConfig.ambientSkyColorIntensity, tonemapping ? 0f : 1f, EnviroSky.instance.cloudsSettings.cloudsExposure));
