...
public class EnviroSkyRendering : MonoBehaviour
{
    ...
    private void RenderVolumeClouds(RenderTexture src, RenderTexture dst)
    {
        ...
        int downsampling = EnviroSky.instance.cloudsSettings.bilateralUpsampling ? reprojectionPixelSize * EnviroSky.instance.cloudsSettings.cloudsRenderResolution : 1;
    ...
    private void RenderFog(RenderTexture src, RenderTexture dst)
    {
        ...
        {
            Shader.SetGlobalVector("_FogNoiseVelocity", new Vector4(-EnviroSky.instance.Components.windZone.transform.forward.x * EnviroSky.instance.windStrenght * 5, -EnviroSky.instance.Components.windZone.transform.forward.z * EnviroSky.instance.windStrenght * 5) * EnviroSky.instance.fogSettings.noiseScale);
        ...
        Shader.SetGlobalVector("_SceneFogMode", new Vector4((int)sceneMode, useRadialDistance ? 1 : 0, 0, Application.isPlaying ? 1f : 0f));
    ...
    private void SetCloudProperties()
    {
        ...
        cloudsMat.SetFloat("_AmbientSkyColorIntensity", 1 - EnviroSky.instance.cloudsConfig.ambientSkyColorIntensity);
        ...
        cloudsMat.SetVector("_CloudsLightingExtended", new Vector4(EnviroSky.instance.cloudsSettings.directionalDarkening.Evaluate(EnviroSky.instance.GameTime.solarTime), 1 - EnviroSky.instance.cloudsConfig.ambientSkyColorIntensity, toneMap, EnviroSky.instance.cloudsSettings.cloudsExposure));

        float bottomH = EnviroSky.instance.cloudsSettings.bottomCloudHeight + EnviroSky.instance.cloudsSettings.cloudsHeightMod;
        float topH = EnviroSky.instance.cloudsSettings.topCloudHeight + EnviroSky.instance.cloudsSettings.cloudsHeightMod;
