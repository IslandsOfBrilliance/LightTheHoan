...
public class EnviroSkyEditor : Editor {
	...
	private string latestVersion = "2.1.2";
	// GUI Styles
	...
	SerializedProperty lightIntensityTransitionSpeed,ambientMode, ambientIntensityCurve, ambientSkyGradient, ambientEquatorGradient, ambientGroundGradient;
    ...
    SerializedProperty bilateralUpsampling,cloudsHeightMod, reprojectionPixelSize, stepsInDepthModificator, lodDistance, shadowCookieSize, flatCloudsTextureIteration, flatCloudsScale, flatCloudsResolution, flatCloudsMorphingSpeed, shadowIntensity, cloudsQuality,customWeatherMap, silverLiningIntensity, silverLiningSpread, weatherAnimSpeedScale, tonemapping,globalCloudCoverage,cirrusCloudsAltitude,flatCloudsAltitude,cloudsWorldScale, BottomCloudHeight,TopCloudHeight, cloudsRenderQuality,raymarchSteps, directionalDarkening, hgPhase,baseNoiseUV,detailNoiseUV,cloudsExposure,cirrusCloudsColor,flatCloudsColor,volumeCloudsColor,volumeCloudsMoonColor,cirrusCloudsTexture,flatCloudsTexture, weatherMapTiling,detailNoiseQuality, LightIntensity;
    ...
    SerializedProperty springBaseTemperature, summerBaseTemperature, autumnBaseTemperature, winterBaseTemperature, temperatureChangingSpeed, dayNightSwitch, snowMeltingTresholdTemperature;
	...
	void OnEnable()
	{
        ...
        directionalDarkening = serializedObj.FindProperty("cloudsSettings.directionalDarkening");
			...
			if (myTarget.showSettings) {
				...
				case EnviroProfile.settingsMode.Clouds:	
                    ...
                    EditorGUILayout.PropertyField(cloudsQuality, true, null);
                        ...
                        {
                            GUILayout.BeginVertical("Advanced Settings", boxStyle);
                            GUILayout.Space(10);
                        ...
                        EditorGUILayout.PropertyField(directionalDarkening, true, null);
                        GUILayout.Space(10);
